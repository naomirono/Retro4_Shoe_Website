...
const ContactForm = () => {
  ...
  return (
    ...
    <div className="flex justify-center items-center h-screen" style={{backgroundImage:`url(${Shoe})`, backgroundPosition: 'center', backgroundSize: 'contain' }}>
  <form onSubmit={handleSubmit} className="max-w-md w-full p-6 bg-white bg-opacity-70 rounded-2xl shadow-5xl border">
